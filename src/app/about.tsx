...
const About: React.FC = () => {
  ...
  return (
    <div 
      id="text-container" 
      ref={aboutRef}
      className="relative flex flex-col w-full lg:w-kic-width h-fit p-2 text-fgSoft bg-black/10 rounded-sm transition-colors duration-[250ms] hover:bg-black/20">
