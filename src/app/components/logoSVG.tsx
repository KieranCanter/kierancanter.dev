...
const logoSVG: React.FC<LogoSVGProps> = ({ width, height, color, hoverColor }) => {
    return (
        <Link href="https://kierancanter.dev" title="KIC">
            ...
            width={width}
            height={height}
            className={`fill-${color} hover:fill-${hoverColor} hover:drop-shadow-[0_10px_10px_rgba(255,0,0,0.5)] transition-all duration-[250ms]`}
            >

            <path className="filter hover:drop-shadow-[0_10px_10px_rgba(255,0,0,0.5)] hover:-translate-y-1 transition-all duration-[250ms]" d="M738.26,0h-285.24L0,540l453.02,540h285.24l-453.02-540L738.26,0ZM648.44,1058.61h-85L128.18,540,563.44,21.39h85L213.18,540l435.27,518.61Z"/>
