...
const About: React.FC = () => {
  ...
  return (
    <div 
      id="text-container" 
      className="relative flex flex-col w-full lg:w-kic-width h-auto p-4 text-fgSoft bg-black/10 rounded-sm transition-colors duration-[250ms] overflow-y-auto lg:hover:bg-black/20">
