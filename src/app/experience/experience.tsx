...
const Experience: React.FC = () => {
  ...
  return (
    <div id="text-container" className="relative flex flex-col gap-4 w-full lg:w-kic-width h-auto m-4 lg:m-auto overflow-y-auto scrollbox pointer-events-none [&_*]:pointer-events-auto">
