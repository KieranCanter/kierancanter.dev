export const experienceContent = [
  {
    ...
    bullets: [
      ...
      'Played a key role in the design and implementation of a streamlined process for building and deploying RPM packages for custom-modified applications, ensuring consistent and scalable distribution across multiple environments using <span class="highlight">Bash</span>',
      'Contributed to a large-scale codebase using <span class="highlight">Git</span> for version control and collaborative development on new features/enhancements',
      'Supported <span class="highlight">Agile</span> project workflow and team collaboration by organizing tasks in <span class="highlight">Jira</span> and documenting processes/technical knowledge in <span class="highlight">Confluence</span>'
    ],
  },
  {
    id: 'tab2',
