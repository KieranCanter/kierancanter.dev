export const worksContent = [
  ...
  },
  {
    ...
    description: "Plugin for the popular Rocket League mod, Bakkesmod. Highly customizable text indicator with decaying gauge bar to visualize the status of your air roll/double jump (for training purposes only). Written using the Bakkesmod SDK.",
    technologies: ['C++'],
  },
  {
