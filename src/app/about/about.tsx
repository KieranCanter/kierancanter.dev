...
const About: React.FC = () => {
  ...
  return (
    <div id="text-container" className="relative flex flex-col w-full lg:w-kic-width h-auto m-4 lg:m-auto p-4 text-fgSoft bg-black/10 rounded-sm overflow-y-auto scrollbox">
