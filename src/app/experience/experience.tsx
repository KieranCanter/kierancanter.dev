...
const Experience: React.FC = () => {
  ...
  return (
    <div id="text-container" className="relative flex flex-col gap-4 w-full lg:w-kic-width h-full overflow-y-auto pointer-events-none [&_*]:pointer-events-auto no-scrollbar">
